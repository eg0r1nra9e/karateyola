    ...
    <Layout style={{ width: 1820, justifyContent: 'space-between' }}>
      <Content style={{ width: 500, padding: 0, minHeight: 750 }}>
        <Player
          ...
          setCount={(count) => {
            setCountOne(countOne + count)
          }}
          setCountFail={(count) => {
            setCountfailOne(countfailOne + count)
          }}
          setCountFail2={(count) => {
            setCountfailOne2(countfailOne2 + count)
          }}
        />
        <div>
          {countfailOne} {countfailOne2}
        </div>
      </Content>
      ...
      <Content style={{ width: 500, padding: '0 2px', minHeight: 10 }}>
        <Player
          ...
          setCount={(count) => {
            setCountTwo(countTwo + count)
          }}
          setCountFail={(count) => {
            setCountfailTwo(countfailTwo + count)
          }}
          setCountFail2={(count) => {
            setCountfailTwo2(countfailTwo2 + count)
          }}
        />
        <div>
          {countfailTwo} {countfailTwo2}
        </div>
      </Content>
    </Layout>,
  )
