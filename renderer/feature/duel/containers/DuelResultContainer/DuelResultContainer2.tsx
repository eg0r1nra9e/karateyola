...
export const DuelResultContainer2 = () => {
  ...
  return (
    <Flex vertical>
      ...
      <Flex style={{ justifyContent: 'space-between' }}>
        <Typography.Title level={1} style={{ margin: 1, width: '50%', color: 'blue', fontSize: '3em' }}>
        ...
        <Typography.Title
          level={1}
          style={{ marginTop: 0, width: '50%', textAlign: 'right', fontSize: '3em' }}
          type="danger"
        >
